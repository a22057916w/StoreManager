...
$sql ="select post_id, addr, area, price, avg_score  from `lease_total_rows_ntc` NATURAL JOIN `lease_score_ntc`
where price >= $price AND price <= ($price+10000) AND area >= $area AND area <= ($area+100)
