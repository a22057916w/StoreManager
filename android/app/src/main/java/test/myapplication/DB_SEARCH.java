...
public class DB_SEARCH {
    public static String executeQuery(String price, String area, String region, String type, String rent) {
        String result = "";

        try {
            URL url = new URL("http://140.136.149.235/test/" + rent + "_search_" + region + ".php");
